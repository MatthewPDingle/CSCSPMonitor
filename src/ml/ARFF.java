...
public class ARFF {
	...
	//		Modelling.buildAndEvaluateModel("RandomForest", 		"-I 300 -K 4 -S 1", "bull", trainStart, trainEnd, testStart, testEnd, 3.0f, 1f, 180, bk, true, Constants.METRICS, metricDiscreteValueHash);
			...
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bear", trainStart, trainEnd, testStart, testEnd, 0.05f, .05f, 3, bk, true, Constants.METRICS, metricDiscreteValueHash);
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bear", trainStart, trainEnd, testStart, testEnd, 0.2f, .1f, 2, bk, true, Constants.METRICS, metricDiscreteValueHash);
			...
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bear", trainStart, trainEnd, testStart, testEnd, 0.4f, .1f, 4, bk, true, Constants.METRICS, metricDiscreteValueHash);
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bear", trainStart, trainEnd, testStart, testEnd, 0.5f, .1f, 5, bk, true, Constants.METRICS, metricDiscreteValueHash);
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bear", trainStart, trainEnd, testStart, testEnd, 0.6f, .1f, 6, bk, true, Constants.METRICS, metricDiscreteValueHash);
	
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bull", trainStart, trainEnd, testStart, testEnd, 0.05f, .05f, 3, bk, true, Constants.METRICS, metricDiscreteValueHash);
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bull", trainStart, trainEnd, testStart, testEnd, 0.2f, .1f, 2, bk, true, Constants.METRICS, metricDiscreteValueHash);
			...
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bull", trainStart, trainEnd, testStart, testEnd, 0.4f, .1f, 4, bk, true, Constants.METRICS, metricDiscreteValueHash);
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bull", trainStart, trainEnd, testStart, testEnd, 0.5f, .1f, 5, bk, true, Constants.METRICS, metricDiscreteValueHash);
			Modelling.buildAndEvaluateModel("RandomForest", 		optionsRandomForest, "bull", trainStart, trainEnd, testStart, testEnd, 0.6f, .1f, 6, bk, true, Constants.METRICS, metricDiscreteValueHash);
