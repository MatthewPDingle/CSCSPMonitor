...
public class BackTester {
	...
	public static void main(String[] args) {
		try {
			...
			// Set time period
			String start = "6/5/2016 00:00:00";
			...
			adjustStops = false;
			maxNumTopModels = 10;
			minSellMetricValue = 0.4d;
			maxSellMetricValue = 1.0d;
			runName = "073 - Rolling " + maxNumTopModels + " Models - 30 Month - .53 - No Stop Adjust - Realistic Positioning - 0.4 - 1.0 SMV - No Closeout 15D Expiration - No MLPs - No Model Weighing - No Veto";
