...
//			BarKey bk = new BarKey("EUR.USD", BAR_SIZE.BAR_2H);
			...
			maxNumTopModels = 1;
			minAlpha = null;
			metricNotes = "03/04/2017Test 28.2990 12 Att. EUR.USD - BAR_1H 1:1 0.0003 PCO DateSet[5] RBFNetwork x60";
			runName = "402 - " + bk.toString() + " 233 Week " + ts.getEngineToString(bk) + " | ";
			runName += metricNotes;
