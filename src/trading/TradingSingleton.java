...
//	private static String ENGINE = "OKCoinPaperRESTLoose";
	...
	protected TradingSingleton() {
		...
		IBWorker ibWorkerZN30M = IBSingleton.getInstance().requestWorker(new BarKey("ZN", BAR_SIZE.BAR_30M));
...
//		IBWorker ibWorkerEURUSD5M = IBSingleton.getInstance().requestWorker(new BarKey("EUR.USD", BAR_SIZE.BAR_5M));
		...
		bkEngineHash.put(new BarKey("ZN", BAR_SIZE.BAR_30M), new IBFutureZNEngine2(ibWorkerZN30M));
