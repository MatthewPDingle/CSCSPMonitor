...
//		TICKER_PIP_SIZE_HASH.put(TICK_NAME_CME_ECBOT_FUTURES_ZN,   .015625); // 1/64th, or 1/2 of 1/32nd.  
		TICKER_PIP_SIZE_HASH.put(TICK_NAME_CME_ECBOT_FUTURES_ZN,   .03125); // 1/32nd.  
