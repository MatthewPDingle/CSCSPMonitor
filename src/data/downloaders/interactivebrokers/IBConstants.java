...
public class IBConstants {
	...
	static {
		...
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_AUD_JPY, BAR_SIZE.BAR_1H), 73);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_AUD_USD, BAR_SIZE.BAR_1H), 74);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_EUR_CHF, BAR_SIZE.BAR_1H), 75);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_EUR_GBP, BAR_SIZE.BAR_1H), 76);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_EUR_JPY, BAR_SIZE.BAR_1H), 77);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_EUR_USD, BAR_SIZE.BAR_1H), 78);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_GBP_JPY, BAR_SIZE.BAR_1H), 79);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_GBP_USD, BAR_SIZE.BAR_1H), 80);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_NZD_USD, BAR_SIZE.BAR_1H), 81);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_USD_CAD, BAR_SIZE.BAR_1H), 82);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_USD_CHF, BAR_SIZE.BAR_1H), 83);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_USD_JPY, BAR_SIZE.BAR_1H), 84);
		
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_AUD_JPY, BAR_SIZE.BAR_2H), 85);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_AUD_USD, BAR_SIZE.BAR_2H), 86);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_EUR_CHF, BAR_SIZE.BAR_2H), 87);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_EUR_GBP, BAR_SIZE.BAR_2H), 88);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_EUR_JPY, BAR_SIZE.BAR_2H), 89);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_EUR_USD, BAR_SIZE.BAR_2H), 90);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_GBP_JPY, BAR_SIZE.BAR_2H), 91);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_GBP_USD, BAR_SIZE.BAR_2H), 92);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_NZD_USD, BAR_SIZE.BAR_2H), 93);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_USD_CAD, BAR_SIZE.BAR_2H), 94);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_USD_CHF, BAR_SIZE.BAR_2H), 95);
		BARKEY_TICKER_ID_HASH.put(new BarKey(TICK_NAME_FOREX_USD_JPY, BAR_SIZE.BAR_2H), 96);
