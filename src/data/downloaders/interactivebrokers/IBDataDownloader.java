...
public class IBDataDownloader implements EWrapper {
	...
	public static void main(String[] args) {
		try {
			...
			String sStart = "10/08/2015 00:00:00.000 EST";
			String sEnd = "11/06/2015 00:00:00.000 EST";
			...
			ibdd.connect();
			ArrayList<Bar> bars = ibdd.downloadHistoricalBars(IBConstants.TICK_NAME_FOREX_USD_JPY, Constants.BAR_SIZE.BAR_1M, start, end, "CASH", false);
			ibdd.disconnect();
			for (Bar bar : bars) {
