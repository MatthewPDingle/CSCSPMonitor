...
//		METRIC_MIN_MAX_VALUE.put("max_breakout200", 100f);
		...
		// TSF is ? - ? when not normalized
		METRIC_MIN_MAX_VALUE.put("min_tsf10", -3f);
		...
		METRIC_MIN_MAX_VALUE.put("min_macd12_26_9", -4f);
		...
		// MACD Signal is -2.5 to 2.5 when not normalized
		METRIC_MIN_MAX_VALUE.put("min_macdsignal12_26_9", -4f);
		...
		// MACD History is -? to ? when not normalized
		METRIC_MIN_MAX_VALUE.put("min_macdhistory12_26_9", -2f);
		...
		// ATR is ? - ? when not normalized
		METRIC_MIN_MAX_VALUE.put("min_atr10", 0f);
		...
		// ATR is ? - ? when not normalized
		METRIC_MIN_MAX_VALUE.put("min_cdlhammer", 0f);
